...
public class SysDepartController {
	...
	public Result<SysDepart> add(@RequestBody SysDepart sysDepart, HttpServletRequest request) {
		...
		try {
			//sysDepart.setStatus(FinalUtil.STATUS);
   ...
   public Result<SysDepart> delete(@RequestParam(name="id",required=true) String id) {
	 ...
	 * @return
	 */
	@GetMapping(value = "/queryConmpanyItems")
	public Result<List<Map<String,Object>>> queryConmpanyItems(){
		Result<List<Map<String,Object>>> result = new Result<List<Map<String,Object>>>();
		List<Map<String,Object>> all=sysDepartService.queryConmpanyItems();
	...
	public Result<SysDepartVo> queryCompanyById(){
		Result<SysDepartVo> result = new Result<SysDepartVo>();
		SysDepartVo sysDepart=sysDepartService.queryCompanyByUserId();
	 ...
	 * @return
	 */
	@GetMapping(value = "/queryBusConmpanyItems")
	public Result<List<Map<String,Object>>> queryBusConmpanyItems(){
		Result<List<Map<String,Object>>> result = new Result<List<Map<String,Object>>>();
		List<Map<String,Object>> all=sysDepartService.queryBusConmpanyItems();
		result.setResult(all);
		result.setSuccess(true);
		return result;
	}
