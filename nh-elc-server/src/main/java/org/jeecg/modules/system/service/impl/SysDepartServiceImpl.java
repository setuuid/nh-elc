...
public class SysDepartServiceImpl<T> extends ServiceImpl<SysDepartMapper, SysDepart> implements ISysDepartService {
	 ...
	 */
	@Override
	public String queryCompanyUserId(String userId) {
        return sysDepartMapper.queryCompanyUserId(userId);
	}
     ...
     */
	@Override
	public List<Map<String, Object>> queryConmpanyItems() {
		List<SysDepart> all = sysDepartMapper.findAll();
		List<Map<String, Object>> mapList= new ArrayList<>();
        for (SysDepart sysDepart : all) {
			Map<String, Object> map = new HashMap<>();
            String id = sysDepart.getId();
            String departName = sysDepart.getDepartName();
			map.put("companyId",id);
			map.put("companyName",departName);
			mapList.add(map);
		}
		return mapList;
	}
	 ...
	 */
	@Override
	public SysDepartVo queryCompanyByUserId() {
		SysUser sysUser = (SysUser) SecurityUtils.getSubject().getPrincipal();
		String userId = sysUser.getId();
		SysDepartVo sysDepartvo=sysDepartMapper.queryCompanyByUserId(userId);
		return sysDepartvo;
	}
	 ...
	 */
	@Override
	public List<Map<String, Object>> queryBusConmpanyItems() {
		List<SysDepart> queryBusConmpanyItems = sysDepartMapper.queryBusConmpanyItems();
		List<Map<String, Object>> mapList= new ArrayList<>();
		for (SysDepart sysDepart : queryBusConmpanyItems) {
			Map<String, Object> map = new HashMap<>();
			String id = sysDepart.getId();
			String departName = sysDepart.getDepartName();
			map.put("companyId",id);
