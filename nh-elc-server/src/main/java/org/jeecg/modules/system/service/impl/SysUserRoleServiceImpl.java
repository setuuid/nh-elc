...
public class SysUserRoleServiceImpl extends ServiceImpl<SysUserRoleMapper, SysUserRole> implements ISysUserRoleService {
	...
	/**   
	 * <p>Title: getRoleByUserId</p>   
	 * <p>Description: </p>   
	 * @param userId
	 * @return   
	 * @see org.jeecg.modules.system.service.ISysUserRoleService#getRoleByUserId(java.lang.String)   
	 */
	@Override
	public List<SysRole> getRoleByUserId(String userId) {
		List<SysRole> listSysRole = sysUserMapper.getRoleByUserId(userId);
		return listSysRole;
	}
