    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="角色分配" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          ...
          <span style="position: absolute;left: -78px;font-family: SimSun;line-height: 1;font-size: 14px;color: #f5222d;top: 3px;">*</span>
          <div v-if="showRoleTip" class="tiptext">请选择用户角色</div>
        </a-form-item>
        <!--部门分配-->
        <a-form-item label="部门分配" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          ...
          <span style="position: absolute;left: -78px;font-family: SimSun;line-height: 1;font-size: 14px;color: #f5222d;top: 3px;">*</span>
          <div v-if="showDepartmentTip" class="tiptext">请选择用户角色</div>
        </a-form-item>
...
<script>
  ...
  export default {
    ...
    watch:{
      'selectedRole'(val){
        if(val!=""){
          this.showRoleTip=false;
        }
      },
      'checkedDepartNameString'(val){
        if(val!=""){
          this.showDepartmentTip=false;
        }
      }
    },
    methods: {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            if(this.selectedRole.length==0){
              this.showRoleTip=true
              that.confirmLoading = false;
            }else if (this.checkedDepartNameString==''){
              this.showDepartmentTip=true
              that.confirmLoading = false;
            }else{
